  ...
  return (
    <Link href={`/profile/${id}`}>
      <div className='flex items-center py-3 px-4 gap-4 hover:bg-neutral-100 rounded-xl user-select-none'>
        <p className='font-body text-lg text-primary-default w-8 text-center select-none'>{USER_POSITION}</p>
        ...
        <p className={cn('text-lg flex-1 font-display select-none', position === 1 && 'premium-cta')}>{name}</p>
