...
const Variants = cva(
  'block h-[57px] w-[65px] rounded-[50%] flex items-center justify-center relative active:translate-y-[8px] active:shadow-none',
  {
    variants: {
      variant: {
        primary:
          'bg-primary-default text-white shadow-[0_8px_0_var(--shadow-primary-color)]'
      }
    },
